...
const DEFAULT_PREFIX = `You are Vishesh Code, an advanced engineering CLI developed by Vishesh Sanghvi.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Vishesh Code, an advanced engineering CLI developed by Vishesh Sanghvi, running within the Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Vishesh agent, built on the Agent SDK.`
